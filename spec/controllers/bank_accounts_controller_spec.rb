...
describe BankAccountsController do
  ...
  describe "GET show" do
    it "assigns the requested bank_account as @bank_account" do
      bank_account = BankAccount.create! valid_attributes
      get :show, :id => bank_account.id.to_s
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bank_account" do
        ...
        put :update, :id => bank_account.id, :bank_account => {'these' => 'params'}
      end

      it "assigns the requested bank_account as @bank_account" do
        bank_account = BankAccount.create! valid_attributes
        put :update, :id => bank_account.id, :bank_account => valid_attributes
        assigns(:bank_account).should eq(bank_account)
      end
    ...
    describe "with invalid params" do
      it "assigns the bank_account as @bank_account" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        BankAccount.any_instance.stub(:save).and_return(false)
        put :update, :id => bank_account.id.to_s, :bank_account => {}
        assigns(:bank_account).should eq(bank_account)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested bank_account" do
      bank_account = BankAccount.create! valid_attributes
      expect {
        delete :destroy, :id => bank_account.id.to_s
      }.to change(BankAccount, :count).by(-1)
    end
