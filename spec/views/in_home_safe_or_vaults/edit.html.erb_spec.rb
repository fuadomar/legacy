...
describe "in_home_safe_or_vaults/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit in_home_safe_or_vault form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => in_home_safe_or_vaults_path(@in_home_safe_or_vault), :method => "post" do
