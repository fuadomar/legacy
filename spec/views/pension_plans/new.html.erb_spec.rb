...
describe "pension_plans/new.html.erb" do
  before(:each) do
    assign(:pension_plan, stub_model(PensionPlan,
  ...
  it "renders new pension_plan form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => pension_plans_path, :method => "post" do
