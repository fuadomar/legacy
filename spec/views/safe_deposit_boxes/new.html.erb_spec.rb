...
describe "safe_deposit_boxes/new.html.erb" do
  before(:each) do
    assign(:safe_deposit_box, stub_model(SafeDepositBox,
      :possession_id => 1,
  ...
  it "renders new safe_deposit_box form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => safe_deposit_boxes_path, :method => "post" do
